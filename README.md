...
5. wget -P ~/rpmbuild/SOURCES http://nodejs.org/dist/v0.10.2/node-v0.10.2.tar.gz
6. wget -P ~/rpmbuild/SPECS https://raw.github.com/krishantaylor/node-rpm-spec/master/nodejs.spec
